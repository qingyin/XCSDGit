...
#if DEV_TEST_POD
	//开发服
//	#define TX_CHAT_SERVER_ENDPOINT                 @"https://dev.xcsdedu.com/http_invoke"
	//测试服
	#define TX_CHAT_SERVER_ENDPOINT               @"http://121.41.101.14:8080/http_invoke"
    #define TX_CHAT_SERVER_TEST                   @"http://121.41.101.14:8080/auth.do?url=http://121.40.16.212/#/"
#else
	//正式服
	#define TX_CHAT_SERVER_ENDPOINT                 @"http://service.xcsdedu.com/http_invoke"
    #define TX_CHAT_SERVER_TEST                     @"http://service.xcsdedu.com/auth.do?url=http://evaluation.xcsdedu.com/#/"
#endif
